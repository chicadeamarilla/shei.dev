...
class UserController extends Controller
{
    ...
    public function actionLogin(){
        ...
        $clean_username = filter_input(INPUT_POST, 'user_email', FILTER_SANITIZE_EMAIL);
        ...
        if($found_user){
           ...
           return json_encode(['err'=>'password is wrong']);
            ...
            // signup
            $shei = new User();
            $shei->username = $clean_username;
            $shei->email = $clean_username; 
            
            $shei->auth_key = Yii::$app->security->generateRandomString();
